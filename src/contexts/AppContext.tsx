...
const translations: Translations = {
  ...
  'about.description1': { es: 'Soy un desarrollador full-stack con más de 3 años de experiencia en el desarrollo de aplicaciones web modernas. Me especializo en JavaScript, React y las últimas tecnologías web, siempre buscando crear experiencias de usuario excepcionales.', en: 'I\'m a full-stack developer with over 3 years of experience developing modern web applications. I specialize in JavaScript, React and the latest web technologies, always looking to create exceptional user experiences.' },
